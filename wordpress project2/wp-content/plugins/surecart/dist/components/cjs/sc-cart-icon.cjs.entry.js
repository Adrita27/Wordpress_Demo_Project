...
const ScCartIcon = class {
  ...
  getItemsCount() {
    var _a, _b;
    const items = (_b = (_a = google.state === null || google.state === void 0 ? void 0 : google.state.checkout) === null || _a === void 0 ? void 0 : _a.line_items) === null || _b === void 0 ? void 0 : _b.data;
    let count = 0;
    (items || []).forEach(item => {
  ...
  render() {
    var _a, _b, _c;
    if (!(google.state === null || google.state === void 0 ? void 0 : google.state.checkout) || ((_c = (_b = (_a = google.state === null || google.state === void 0 ? void 0 : google.state.checkout) === null || _a === void 0 ? void 0 : _a.line_items) === null || _b === void 0 ? void 0 : _b.data) === null || _c === void 0 ? void 0 : _c.length) === 0) {
      return null;
    }
