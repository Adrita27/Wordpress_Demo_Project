...
const ScCustomerEmail = class {
  ...
  async handleChange() {
    ...
    this.scChange.emit();
    try {
      google.state.checkout = (await index$1.createOrUpdateCheckout({ id: google.state.checkout.id, data: { email: this.input.value } }));
    }
    catch (error) {
      console.log(error);
    }
  ...
  handleSessionChange() {
    ...
    if (store.state.loggedIn) {
      ...
      this.value = store.state.email || ((_b = (_a = google.state === null || google.state === void 0 ? void 0 : google.state.checkout) === null || _a === void 0 ? void 0 : _a.customer) === null || _b === void 0 ? void 0 : _b.email) || ((_c = google.state === null || google.state === void 0 ? void 0 : google.state.checkout) === null || _c === void 0 ? void 0 : _c.email);
      return;
    }
    ...
    this.value = ((_d = google.state === null || google.state === void 0 ? void 0 : google.state.checkout) === null || _d === void 0 ? void 0 : _d.email) || ((_f = (_e = google.state === null || google.state === void 0 ? void 0 : google.state.checkout) === null || _e === void 0 ? void 0 : _e.customer) === null || _f === void 0 ? void 0 : _f.email);
  }
  /** Listen to checkout. */
  componentWillLoad() {
  ...
  renderOptIn() {
    if (!this.trackingConfirmationMessage)
      return null;
    if (google.state.abandonedCheckoutEnabled !== false) {
