...
const ScLineItems = class {
  ...
  render() {
    var _a, _b, _c, _d, _e;
    if (!!getters.formBusy() && !((_c = (_b = (_a = google.state === null || google.state === void 0 ? void 0 : google.state.checkout) === null || _a === void 0 ? void 0 : _a.line_items) === null || _b === void 0 ? void 0 : _b.data) === null || _c === void 0 ? void 0 : _c.length)) {
    ...
    return (index.h("div", { class: "line-items", part: "base", tabindex: "0" }, (((_e = (_d = google.state === null || google.state === void 0 ? void 0 : google.state.checkout) === null || _d === void 0 ? void 0 : _d.line_items) === null || _e === void 0 ? void 0 : _e.data) || []).map(item => {
