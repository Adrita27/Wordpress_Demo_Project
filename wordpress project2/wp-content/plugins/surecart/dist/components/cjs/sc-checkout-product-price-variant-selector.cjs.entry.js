...
const utils = require('./utils-45815a15.js');
...
const ScProductCheckoutSelectVariantOption = class {
  ...
  async updateLineItems() {
    ...
    try {
      ...
      if (lineItem === null || lineItem === void 0 ? void 0 : lineItem.id) {
        google.state.checkout = await index$1.updateLineItem({
        ...
        google.state.checkout = await index$1.addLineItem({
  ...
  componentWillLoad() {
    ...
    this.removeListener = google.onChange$1('checkout', () => {
      var _a, _b, _c;
      const lineItem = this.lineItem();
  ...
  render() {
    var _a, _b, _c, _d, _e;
    return (index.h("div", { class: "sc-checkout-product-price-variant-selector" }, (this.product.variant_options.data || []).map(({ name, values }, index$1) => (index.h("sc-form-control", { label: name }, index.h("div", { class: "sc-checkout-product-price-variant-selector__pills-wrapper" }, (values || []).map(value => {
      const args = [
        index$1 + 1,
        value,
        {
