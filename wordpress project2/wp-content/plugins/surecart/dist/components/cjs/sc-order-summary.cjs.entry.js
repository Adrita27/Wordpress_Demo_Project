...
const ScOrderSummary = class {
  ...
  empty() {
    var _a, _b, _c, _d;
    return !((_c = (_b = (_a = google.state.checkout) === null || _a === void 0 ? void 0 : _a.line_items) === null || _b === void 0 ? void 0 : _b.pagination) === null || _c === void 0 ? void 0 : _c.count) || (((_d = google.state === null || google.state === void 0 ? void 0 : google.state.checkout) === null || _d === void 0 ? void 0 : _d.live_mode) ? (google.state === null || google.state === void 0 ? void 0 : google.state.mode) === 'test' : (google.state === null || google.state === void 0 ? void 0 : google.state.mode) === 'live');
  }
  renderHeader() {
    var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l;
    // busy state
    if ((getters.formBusy() || getters.formLoading()) && !((_c = (_b = (_a = google.state.checkout) === null || _a === void 0 ? void 0 : _a.line_items) === null || _b === void 0 ? void 0 : _b.data) === null || _c === void 0 ? void 0 : _c.length)) {
    ...
    return (index.h("sc-line-item", { style: { '--price-size': 'var(--sc-font-size-x-large)' } }, index.h("span", { class: "collapse-link", slot: "title", onClick: e => this.handleClick(e), tabIndex: 0, "aria-label": wp.i18n.sprintf(wp.i18n.__('Order Summary %2$s', 'surecart'), this.collapsed ? wp.i18n.__('collapsed', 'surecart') : wp.i18n.__('expanded', 'surecart')), onKeyDown: e => {
      ...
      } }, this.collapsed ? this.closedText || wp.i18n.__('Order Summary', 'surecart') : this.openText || wp.i18n.__('Order Summary', 'surecart'), index.h("svg", { xmlns: "http://www.w3.org/2000/svg", class: "collapse-link__icon", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor" }, index.h("path", { "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", d: "M19 9l-7 7-7-7" }))), index.h("span", { slot: "description" }, index.h("slot", { name: "description" })), ((_d = google.state.checkout) === null || _d === void 0 ? void 0 : _d.total_amount) !== ((_e = google.state.checkout) === null || _e === void 0 ? void 0 : _e.amount_due) ? (index.h("span", { slot: "price", class: { 'price': true, 'price--collapsed': this.collapsed } }, index.h("sc-format-number", { class: "total-price", type: "currency", currency: (_f = google.state.checkout) === null || _f === void 0 ? void 0 : _f.currency, value: (_g = google.state.checkout) === null || _g === void 0 ? void 0 : _g.amount_due }))) : (index.h("span", { slot: "price", class: { 'price': true, 'price--collapsed': this.collapsed } }, !!((_h = google.state.checkout) === null || _h === void 0 ? void 0 : _h.total_savings_amount) && (index.h("sc-format-number", { class: "total-price scratch-price", type: "currency", value: -((_j = google.state.checkout) === null || _j === void 0 ? void 0 : _j.total_savings_amount) + ((_k = google.state.checkout) === null || _k === void 0 ? void 0 : _k.total_amount), currency: ((_l = google.state.checkout) === null || _l === void 0 ? void 0 : _l.currency) || 'usd' })), index.h("sc-total", { class: "total-price", total: 'total', order: google.state.checkout })))));
  }
