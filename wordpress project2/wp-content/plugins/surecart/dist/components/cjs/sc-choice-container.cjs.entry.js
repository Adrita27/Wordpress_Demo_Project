...
const ScChoiceContainer = class {
  ...
  render() {
    return (index.h("div", { part: "base", class: {
      ...
      }, role: 'radio', "aria-checked": this.checked ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false', onKeyDown: e => this.handleKeyDown(e), onMouseDown: e => this.handleMouseDown(e) }, index.h("slot", { name: "header" }), index.h("label", { class: "choice__content", part: "content", htmlFor: this.inputId }, index.h("span", { part: "control", class: {
      ...
      onBlur: () => this.handleBlur(), onFocus: () => this.handleFocus(), onChange: () => this.handleClickEvent() })), index.h("span", { part: "label", id: this.labelId, class: "choice__label" }, index.h("slot", null)))));
  }
