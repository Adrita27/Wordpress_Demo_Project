...
const ScOrderCouponForm = class {
  ...
  render() {
    ...
    const hasRecurring = (_c = (_b = (_a = google.state === null || google.state === void 0 ? void 0 : google.state.checkout) === null || _a === void 0 ? void 0 : _a.line_items) === null || _b === void 0 ? void 0 : _b.data) === null || _c === void 0 ? void 0 : _c.some(item => { var _a; return (_a = item === null || item === void 0 ? void 0 : item.price) === null || _a === void 0 ? void 0 : _a.recurring_interval; });
    return (index.h("sc-coupon-form", { label: this.label || wp.i18n.__('Add Coupon Code', 'surecart'), collapsed: this.collapsed, placeholder: this.placeholder, loading: getters.formBusy() && !((_f = (_e = (_d = google.state.checkout) === null || _d === void 0 ? void 0 : _d.line_items) === null || _e === void 0 ? void 0 : _e.data) === null || _f === void 0 ? void 0 : _f.length), busy: getters.formBusy(), discount: (_g = google.state.checkout) === null || _g === void 0 ? void 0 : _g.discount, currency: (_h = google.state.checkout) === null || _h === void 0 ? void 0 : _h.currency, "discount-amount": (_j = google.state.checkout) === null || _j === void 0 ? void 0 : _j.discount_amount, class: {
