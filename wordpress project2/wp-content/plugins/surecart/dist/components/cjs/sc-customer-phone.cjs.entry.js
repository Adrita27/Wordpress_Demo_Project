...
const ScCustomerPhone = class {
  ...
  componentWillLoad() {
    ...
    this.removeChangeListener = google.onChange$1('checkout', () => this.handleCheckoutChange());
  }
  ...
  handleCheckoutChange() {
    ...
    if ((_a = google.state.checkout) === null || _a === void 0 ? void 0 : _a.phone) {
      this.value = (_b = google.state.checkout) === null || _b === void 0 ? void 0 : _b.phone;
      return;
    }
    // if the customer has a phone, use that.
    if ((_d = (_c = google.state.checkout) === null || _c === void 0 ? void 0 : _c.customer) === null || _d === void 0 ? void 0 : _d.phone) {
      this.value = (_f = (_e = google.state.checkout) === null || _e === void 0 ? void 0 : _e.customer) === null || _f === void 0 ? void 0 : _f.phone;
      return;
    }
  }
  render() {
