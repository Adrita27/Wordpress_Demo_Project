...
const mutations$1 = require('./mutations-2bbd713b.js');
...
const ScCartSessionProvider = class {
  ...
  async update(data = {}, query = {}) {
    ...
    try {
      google.state.checkout = (await index$1.updateCheckout({
        id: (_a = google.state.checkout) === null || _a === void 0 ? void 0 : _a.id,
        data: {
          ...data,
        },
        query: {
  ...
  render() {
    return (index.h("sc-line-items-provider", { order: google.state.checkout, onScUpdateLineItems: e => this.loadUpdate({ line_items: e.detail }) }, index.h("slot", null)));
  }
