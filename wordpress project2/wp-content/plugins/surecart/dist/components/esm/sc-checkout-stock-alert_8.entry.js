...
import { s as state, b as onChange, r as removeQueryArgs } from './google-cb3a19c3.js';
import { d as updateCheckout, e as expand, f as finalizeCheckout, g as fetchCheckout, c as createOrUpdateCheckout } from './index-d8b1c389.js';
import { c as currentFormState } from './getters-26bb263b.js';
import { v, c as checkoutMachine, s as state$1 } from './store-b85bbb50.js';
...
import { c as clearCheckout } from './mutations-39aa07b2.js';
...
const ScFormComponentsValidator = class {
  ...
  handleOrderChange() {
    ...
    if (((_a = state.checkout) === null || _a === void 0 ? void 0 : _a.tax_status) === 'address_invalid' || ((_b = state.checkout) === null || _b === void 0 ? void 0 : _b.shipping_enabled) || ((_c = state.checkout) === null || _c === void 0 ? void 0 : _c.shipping_address_required)) {
      this.addAddressField();
    }
    // add order bumps.
    if ((_f = (_e = (_d = state.checkout) === null || _d === void 0 ? void 0 : _d.recommended_bumps) === null || _e === void 0 ? void 0 : _e.data) === null || _f === void 0 ? void 0 : _f.length) {
      this.addBumps();
    }
    if (!!((_g = state.checkout) === null || _g === void 0 ? void 0 : _g.tax_amount)) {
      this.addTaxLine();
    }
    // add shipping choices.
    if (((_h = state.checkout) === null || _h === void 0 ? void 0 : _h.shipping_enabled) && ((_j = state.checkout) === null || _j === void 0 ? void 0 : _j.selected_shipping_choice_required)) {
      this.addShippingChoices();
    }
    if (!!((_k = state.checkout) === null || _k === void 0 ? void 0 : _k.shipping_amount)) {
