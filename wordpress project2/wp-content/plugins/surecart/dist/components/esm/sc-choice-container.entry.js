...
const ScChoiceContainer = class {
  ...
  render() {
    return (h("div", { part: "base", class: {
      ...
      }, role: 'radio', "aria-checked": this.checked ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false', onKeyDown: e => this.handleKeyDown(e), onMouseDown: e => this.handleMouseDown(e) }, h("slot", { name: "header" }), h("label", { class: "choice__content", part: "content", htmlFor: this.inputId }, h("span", { part: "control", class: {
      ...
      onBlur: () => this.handleBlur(), onFocus: () => this.handleFocus(), onChange: () => this.handleClickEvent() })), h("span", { part: "label", id: this.labelId, class: "choice__label" }, h("slot", null)))));
  }
